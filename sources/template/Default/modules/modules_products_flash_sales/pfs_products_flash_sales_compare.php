 ...
 */
  ...
  use ClicShopping\Custom\Sites\Shop\Pages\FlashSales\Classes\Shop\FlashSalesClass;

  class pfs_products_flash_sales_compare {
    public $code;
    public $group;
    public $title;
    public $description;
    ...
    public function __construct() {
      ...
      $this->title = CLICSHOPPING::getDef('module_products_products_flash_sales_compare_title');
      $this->description = CLICSHOPPING::getDef('module_products_products_flash_sales_compare_description');

      if (defined('MODULE_PRODUCTS_FLASH_SALES_STATUS')) {
        $this->sort_order = MODULE_PRODUCTS_FLASH_SALES_SALES_COMPARE_SORT_ORDER;
        $this->enabled = (MODULE_PRODUCTS_FLASH_SALES_SALES_COMPARE_STATUS == 'True');
      }
    }
    ...
    public function execute() {
      ...
      if (isset($_GET['FlashSales']) && isset($_GET['Flash'])) {

        if (MODULE_PRODUCTS_FLASH_SALES_MAX_DISPLAY != 0 ) {
          $Qlisting = FLashSalesClass::getListing();

          $Qlisting->setPageSet((int)MODULE_PRODUCTS_FLASH_SALES_COMPARE_MAX_DISPLAY);
          $Qlisting->execute();

          $listingTotalRow = $Qlisting->getPageSetTotalRows();

          $new_prods_content = '<!-- FLashSales Products start -->' . "\n";
          $new_prods_content .= '<div class="clearfix"></div>';
          $new_prods_content .= '<div class="contentText">';
          $new_prods_content .= '<div class="ModulesProductsFLashSalesContainer">';

          if ($listingTotalRow > 0) {

            $new_prods_content .= '<div class="col-md-5 float-start">';
            $new_prods_content .= '<div class="page-header ModulesProductsFLashSalesHeadingTitle">';
...
// number of sort criterias
            $column_list = FLashSalesClass::getCountColumnList();

            for ($col = 0, $n = count($column_list); $col < $n; $col++) {
              switch ($column_list[$col]) {
                case 'MODULE_PRODUCTS_FLASH_SALES_LIST_DATE_ADDED':
                  $lc_text = CLICSHOPPING::getDef('table_heading_date');
                break;
                case 'MODULE_PRODUCTS_FLASH_SALES_LIST_PRICE':
                  $lc_text = CLICSHOPPING::getDef('table_heading_price');
                break;
                case 'MODULE_PRODUCTS_FLASH_SALES_LIST_MODEL':
                  $lc_text = CLICSHOPPING::getDef('table_heading_model');
                break;
                case 'MODULE_PRODUCTS_FLASH_SALES_LIST_QUANTITY':
                  $lc_text = CLICSHOPPING::getDef('table_heading_quantity');
                break;
                case 'MODULE_PRODUCTS_FLASH_SALES_LIST_WEIGHT':
...
*/
          ...
          $new_prods_content .= '</div>' . "\n";
          $new_prods_content .= '<div class="boxContentsModulesProductsFLashSales">';
...
// display number of short description
            $products_short_description_number = (int)MODULE_PRODUCTS_FLASH_SALES_COMPARE_SHORT_DESCRIPTION;
// delete words
            $delete_word = (int)MODULE_PRODUCTS_FLASH_SALES_COMPARE_SHORT_DESCRIPTION_DELETE_WORLDS;
// nbr of column to display  boostrap
            $bootstrap_column = (int)MODULE_PRODUCTS_FLASH_SALES_COMPARE_COLUMNS;
// initialisation des boutons
            $size_button = $CLICSHOPPING_ProductsCommon->getSizeButton('md');

// Template define
            $filename= '';
            $filename = $CLICSHOPPING_Template-> getTemplateModulesFilename($this->group .'/template_html/' . MODULE_PRODUCTS_FLASH_SALES_COMPARE_TEMPLATE);
...
//Stock (good, alert, out of stock).
              $products_stock = $CLICSHOPPING_ProductsFunctionTemplate->getStock(MODULE_PRODUCTS_FLASH_SALES_COMPARE_DISPLAY_STOCK, $products_id);
//Flash discount
...
// Display an input allowing for the customer to insert a quantity
              $input_quantity = $CLICSHOPPING_ProductsFunctionTemplate->getDisplayInputQuantity(MODULE_PRODUCTS_FLASH_SALES_COMPARE_DELETE_BUY_BUTTON, $products_id);
...
// **************************
              ...
              if (MODULE_PRODUCTS_FLASH_SALES_COMPARE_DELETE_BUY_BUTTON == 'False') {
                if ($CLICSHOPPING_ProductsCommon->getProductsMinimumQuantity($products_id) != 0 && $CLICSHOPPING_ProductsCommon->getProductsQuantity($products_id) != 0) {
                  if ($CLICSHOPPING_ProductsAttributes->getHasProductAttributes($products_id) === false) {
                    ...
                    if (isset($_GET['FLashSales'])) $form .= HTML::hiddenField('url', 'Products&FLashSales');
                    $endform = '</form>';
...
// See the button more view details
               $button_small_view_details = $CLICSHOPPING_ProductsFunctionTemplate->getButtonViewDetails(MODULE_PRODUCTS_FLASH_SALES_COMPARE_DELETE_BUY_BUTTON, $products_id);
// Display the image
              $products_image = $CLICSHOPPING_ProductsFunctionTemplate->getImage(MODULE_PRODUCTS_FLASH_SALES_COMPARE_IMAGE_MEDIUM, $products_id);
// Ticker Image
              $products_image .= $CLICSHOPPING_ProductsFunctionTemplate->getTicker(MODULE_PRODUCTS_FLASH_SALES_COMPARE_TICKER, $products_id, 'ModulesProductsFlashSalesBootstrapTickerSpecial', 'ModulesProductsFlashSalesBootstrapTickerFavorites', 'ModulesProductsFlashSalesBootstrapTickerFeatured', 'ModulesProductsFlashSalesBootstrapTickerNew');

              $ticker = $CLICSHOPPING_ProductsFunctionTemplate->getTickerPourcentage(MODULE_PRODUCTS_FLASH_SALES_COMPARE_POURCENTAGE_TICKER, $products_id, 'ModulesProductsFlashSalesBootstrapTickerPourcentage');
...
// products_compare
            $new_prods_content .= '<div class="col-md-12 stickProductsFlashSalesCompare" id="compare">';
            $new_prods_content .= '<div class="separator"></div>';
            $new_prods_content .= '<div class="text-center">';
            $new_prods_content .= '<button class="btn">';
            $new_prods_content .= HTML::link(CLICSHOPPING::link(null, 'FlashSales&Flash'), CLICSHOPPING::getDef('text_products_compare_selected')) . '</button>';
            $new_prods_content .= '</div>';
            $new_prods_content .= '</div>';
          } else {
        ...
        $new_prods_content .= '<!--  Products products_flash_sales_compare End -->' . "\n";
    ...
    public function check() {
      return defined('MODULE_PRODUCTS_FLASH_SALES_COMPARE_STATUS');
    }
    ...
    public function install() {
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULE_PRODUCTS_FLASH_SALES_COMPARE_STATUS',
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULE_PRODUCTS_FLASH_SALES_COMPARE_TEMPLATE',
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULE_PRODUCTS_FLASH_SALES_COMPARE_MAX_DISPLAY',
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULE_PRODUCTS_FLASH_SALES_COMPARE_COLUMNS',
          'configuration_value' => '6',
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULE_PRODUCTS_FLASH_SALES_COMPARE_SHORT_DESCRIPTION',
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULE_PRODUCTS_FLASH_SALES_COMPARE_SHORT_DESCRIPTION_DELETE_WORLDS',
          'configuration_value' => '0',
      ...
      $CLICSHOPPING_Db->save('configuration', [
          'configuration_title' => 'Do you want to display a message News / FLashSales / Favorites / Featured ?',
          'configuration_key' => 'MODULE_PRODUCTS_FLASH_SALES_COMPARE_TICKER',
          'configuration_value' => 'False',
          'configuration_description' => 'Display a message News / FLashSales / Favorites / Featured',
          'configuration_group_id' => '6',
          'sort_order' => '1',
          'set_function' => 'clic_cfg_set_boolean_value(array(\'True\', \'False\'))',
          'date_added' => 'now()'
      ...
      $CLICSHOPPING_Db->save('configuration', [
          'configuration_title' => 'Do you want to display the discount pourcentage (products_flash_sales_compare) ?',
          'configuration_key' => 'MODULE_PRODUCTS_FLASH_SALES_COMPARE_POURCENTAGE_TICKER',
          'configuration_value' => 'False',
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULE_PRODUCTS_FLASH_SALES_COMPARE_DISPLAY_STOCK',
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULE_PRODUCTS_FLASH_SALES_LIST_DATE_ADDED',
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULE_PRODUCTS_FLASH_SALES_LIST_PRICE',
          'configuration_value' => '0',
          'configuration_description' => 'This option allow to choose an order to display the product. Lowest is displayed in first; 0 for nothing',
          'configuration_group_id' => '6',
          'sort_order' => '6',
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULE_PRODUCTS_FLASH_SALES_LIST_MODEL',
          'configuration_value' => '0',
          'configuration_description' => 'This option allow to choose an order to display the product. Lowest is displayed in first; 0 for nothing',
          'configuration_group_id' => '6',
          'sort_order' => '7',
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULE_PRODUCTS_FLASH_SALES_LIST_QUANTITY',
          'configuration_value' => '0',
          'configuration_description' => 'This option allow to choose an order to display the product. Lowest is displayed in first; 0 for nothing',
          'configuration_group_id' => '6',
          'sort_order' => '8',
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULE_PRODUCTS_FLASH_SALES_LIST_WEIGHT',
          'configuration_value' => '0',
          'configuration_description' => 'This option allow to choose an order to display the product. Lowest is displayed in first; 0 for nothing',
          'configuration_group_id' => '6',
          'sort_order' => '9',
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULE_PRODUCTS_FLASH_SALES_COMPARE_IMAGE_MEDIUM',
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULE_PRODUCTS_FLASH_SALES_COMPARE_DELETE_BUY_BUTTON',
          'configuration_value' => 'False',
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULE_PRODUCTS_FLASH_SALES_COMPARE_SORT_ORDER',
    ...
    public function keys() {
      return array (
        'MODULE_PRODUCTS_FLASH_SALES_COMPARE_STATUS',
        'MODULE_PRODUCTS_FLASH_SALES_COMPARE_TEMPLATE',
        'MODULE_PRODUCTS_FLASH_SALES_COMPARE_MAX_DISPLAY',
        'MODULE_PRODUCTS_FLASH_SALES_COMPARE_COLUMNS',
        'MODULE_PRODUCTS_FLASH_SALES_COMPARE_SHORT_DESCRIPTION',
        'MODULE_PRODUCTS_FLASH_SALES_COMPARE_SHORT_DESCRIPTION_DELETE_WORLDS',
        'MODULE_PRODUCTS_FLASH_SALES_COMPARE_TICKER',
        'MODULE_PRODUCTS_FLASH_SALES_COMPARE_POURCENTAGE_TICKER',
        'MODULE_PRODUCTS_FLASH_SALES_COMPARE_DISPLAY_STOCK',
        'MODULE_PRODUCTS_FLASH_SALES_LIST_DATE_ADDED',
        'MODULE_PRODUCTS_FLASH_SALES_LIST_PRICE',
        'MODULE_PRODUCTS_FLASH_SALES_LIST_MODEL',
        'MODULE_PRODUCTS_FLASH_SALES_LIST_QUANTITY',
        'MODULE_PRODUCTS_FLASH_SALES_LIST_WEIGHT',
        'MODULE_PRODUCTS_FLASH_SALES_COMPARE_IMAGE_MEDIUM',
        'MODULE_PRODUCTS_FLASH_SALES_COMPARE_DELETE_BUY_BUTTON',
        'MODULE_PRODUCTS_FLASH_SALES_COMPARE_SORT_ORDER'
      );
    }
  }
