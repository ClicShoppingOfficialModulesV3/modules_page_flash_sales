 ...
 */
  ...
  class pfs_products_flash_sales {
    public $code;
    public $group;
    public $title;
    public $description;
    ...
    public function __construct() {
      ...
      $this->title = CLICSHOPPING::getDef('module_products_flash_sales_title');
      $this->description = CLICSHOPPING::getDef('module_products_flash_sales_description');

      if (defined('MODULE_PRODUCTS_FLASH_SALES_STATUS')) {
        $this->sort_order = MODULE_PRODUCTS_FLASH_SALES_SORT_ORDER;
        $this->enabled = (MODULE_PRODUCTS_FLASH_SALES_STATUS == 'True');
      }
    }
    ...
    public function execute() {
      ...
      if (isset($_GET['FlashSales']) && isset($_GET['Flash'])) {
        ...
        if (MODULE_PRODUCTS_FLASH_SALES_MAX_DISPLAY != 0 ) {
          ...
          $Qlisting->setPageSet((int)MODULE_PRODUCTS_FLASH_SALES_MAX_DISPLAY);
          $Qlisting->execute();
...
// display number of short description
            $products_short_description_number = (int)MODULE_PRODUCTS_FLASH_SALES_SHORT_DESCRIPTION;
// delete words
            $delete_word = (int)MODULE_PRODUCTS_FLASH_SALES_SHORT_DESCRIPTION_DELETE_WORLDS;
// nbr of column to display  boostrap
            $bootstrap_column = (int)MODULE_PRODUCTS_FLASH_SALES_COLUMNS;
// initialisation des boutons
            $size_button = $CLICSHOPPING_ProductsCommon->getSizeButton('md');

// Template define
            $filename= '';
            $filename = $CLICSHOPPING_Template-> getTemplateModulesFilename($this->group .'/template_html/' . MODULE_PRODUCTS_FLASH_SALES_TEMPLATE);
...
//Stock (good, alert, out of stock).
              $products_stock = $CLICSHOPPING_ProductsFunctionTemplate->getStock(MODULE_PRODUCTS_FLASH_SALES_DISPLAY_STOCK, $products_id);
//Flash discount
...
// Display an input allowing for the customer to insert a quantity
              $input_quantity = $CLICSHOPPING_ProductsFunctionTemplate->getDisplayInputQuantity(MODULE_PRODUCTS_FLASH_SALES_DELETE_BUY_BUTTON, $products_id);
...
// **************************
              ...
              if (MODULE_PRODUCTS_FLASH_SALES_DELETE_BUY_BUTTON == 'False') {
...
// See the button more view details
               $button_small_view_details = $CLICSHOPPING_ProductsFunctionTemplate->getButtonViewDetails(MODULE_PRODUCTS_FLASH_SALES_DELETE_BUY_BUTTON, $products_id);
// Display the image
              $products_image = $CLICSHOPPING_ProductsFunctionTemplate->getImage(MODULE_PRODUCTS_FLASH_SALES_IMAGE_MEDIUM, $products_id);
// Ticker Image
              $products_image .= $CLICSHOPPING_ProductsFunctionTemplate->getTicker(MODULE_PRODUCTS_FLASH_SALES_TICKER, $products_id, 'ModulesProductsFlashSalesBootstrapTickerSpecial', 'ModulesProductsFlashSalesBootstrapTickerFavorites', 'ModulesProductsFlashSalesBootstrapTickerFeatured', 'ModulesProductsFlashSalesBootstrapTickerNew');

              $ticker = $CLICSHOPPING_ProductsFunctionTemplate->getTickerPourcentage(MODULE_PRODUCTS_FLASH_SALES_POURCENTAGE_TICKER, $products_id, 'ModulesProductsFlashSalesBootstrapTickerPourcentage');
...
// **************************
        ...
        $new_prods_content .= '<!--  Products flash_sales End -->' . "\n";
    ...
    public function check() {
      return defined('MODULE_PRODUCTS_FLASH_SALES_STATUS');
    }
    ...
    public function install() {
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULE_PRODUCTS_FLASH_SALES_STATUS',
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULE_PRODUCTS_FLASH_SALES_TEMPLATE',
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULE_PRODUCTS_FLASH_SALES_MAX_DISPLAY',
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULE_PRODUCTS_FLASH_SALES_COLUMNS',
          'configuration_value' => '6',
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULE_PRODUCTS_FLASH_SALES_SHORT_DESCRIPTION',
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULE_PRODUCTS_FLASH_SALES_SHORT_DESCRIPTION_DELETE_WORLDS',
          'configuration_value' => '0',
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULE_PRODUCTS_FLASH_SALES_TICKER',
      ...
      $CLICSHOPPING_Db->save('configuration', [
          'configuration_title' => 'Do you want to display the discount pourcentage (flash_sales) ?',
          'configuration_key' => 'MODULE_PRODUCTS_FLASH_SALES_POURCENTAGE_TICKER',
          'configuration_value' => 'False',
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULE_PRODUCTS_FLASH_SALES_DISPLAY_STOCK',
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULE_PRODUCTS_FLASH_SALES_IMAGE_MEDIUM',
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULE_PRODUCTS_FLASH_SALES_DELETE_BUY_BUTTON',
          'configuration_value' => 'False',
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_key' => 'MODULE_PRODUCTS_FLASH_SALES_SORT_ORDER',
    ...
    public function keys() {
      return array (
        'MODULE_PRODUCTS_FLASH_SALES_STATUS',
        'MODULE_PRODUCTS_FLASH_SALES_TEMPLATE',
        'MODULE_PRODUCTS_FLASH_SALES_MAX_DISPLAY',
        'MODULE_PRODUCTS_FLASH_SALES_COLUMNS',
        'MODULE_PRODUCTS_FLASH_SALES_SHORT_DESCRIPTION',
        'MODULE_PRODUCTS_FLASH_SALES_SHORT_DESCRIPTION_DELETE_WORLDS',
        'MODULE_PRODUCTS_FLASH_SALES_TICKER',
        'MODULE_PRODUCTS_FLASH_SALES_POURCENTAGE_TICKER',
        'MODULE_PRODUCTS_FLASH_SALES_DISPLAY_STOCK',
        ...
        'MODULE_PRODUCTS_FLASH_SALES_IMAGE_MEDIUM',
        'MODULE_PRODUCTS_FLASH_SALES_DELETE_BUY_BUTTON',
        'MODULE_PRODUCTS_FLASH_SALES_SORT_ORDER'
      );
    }
  }
